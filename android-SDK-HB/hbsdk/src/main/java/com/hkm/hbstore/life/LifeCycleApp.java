...
import com.hypebeast.hbsdk.clients.HBStoreApiClient;
...
public class LifeCycleApp extends Application {
    ...
    protected HBStoreApiClient store;
    private Brand mbrand;
    private Products mproducts;

    private void initHBStoreSDK() {
        store = new HBStoreApiClient();
        mbrand = store.createBrand();
        mproducts = store.createProducts();
    }

    public Brand getRequestBrand() {
        return mbrand;
    }

    public Products getRequestProducts() {
        return mproducts;
    }

    public HBStoreApiClient getSingleProduct() {
        return store;
    }
